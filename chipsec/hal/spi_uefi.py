...
from chipsec.hal.uefi_fv import EFI_FIRMWARE_CONTENTS_SIGNED_GUID, WIN_CERT_TYPE_EFI_GUID, WIN_CERTIFICATE_size, WIN_CERTIFICATE, EFI_FIRMWARE_VOLUME_HEADER_size
...
def build_efi_tree(_uefi, data, fwtype):
    ...
    while fv is not None:
        ...
        fvolumes.append(fv)
        fv = NextFwVolume(data, fv.Offset + max(fv.Size, EFI_FIRMWARE_VOLUME_HEADER_size))
